...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($nom) || empty($prenom) || empty($email) || empty($niveau) || 
        empty($filiere) || empty($classe) || empty($password)) {
    ...
    elseif ($password !== $confirmPassword) {
        $alertTitle = "Mots de Passe Différents";
        $alertMessage = "Les mots de passe saisis ne correspondent pas.";
        $alertType = "error";
        $errors = true;
    }
    ...
    if (!$errors) {
        try {
            ...
            insertE($db,$email,$nom,$prenom,$password,$filiere,$classe,$niveau);
            /*
            ...
            */
            ...
            $alertMessage = "Votre compte étudiant a été créé avec succès. Vous allez recevoir un email de confirmation dans quelques instants.";
            $alertType = "success";
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group">
                ...
                <select id="niveau" name="niveau" >
                    <option value="" disabled <?php echo !isset($niveau) ? 'selected' : ''; ?>>Sélectionnez votre niveau</option>
                    <option value="1" <?php echo (isset($niveau) && $niveau == '1') ? 'selected' : ''; ?>>Niveau 1</option>
                    <option value="2" <?php echo (isset($niveau) && $niveau == '2') ? 'selected' : ''; ?>>Niveau 2</option>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <select id="filiere" name="filiere">
                    <option value="" disabled <?php echo !isset($filiere) ? 'selected' : ''; ?>>Sélectionnez votre filière</option>
                    <option value="prepa" <?php echo (isset($filiere) && $filiere == 'prepa') ? 'selected' : ''; ?>>Prépa</option>
                    <option value="gl" <?php echo (isset($filiere) && $filiere == 'gl') ? 'selected' : ''; ?>>Génie Logiciel (GL)</option>
                    <option value="rsi" <?php echo (isset($filiere) && $filiere == 'rsi') ? 'selected' : ''; ?>>Réseaux et Systèmes Informatiques (RSI)</option>
                    <option value="telecom" <?php echo (isset($filiere) && $filiere == 'telecom') ? 'selected' : ''; ?>>Télécommunications (TELECOM)</option>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="radio-group">
                    <div class="radio-option">
                        <input type="radio" id="classeA" name="classe" value="A" <?php echo (isset($classe) && $classe == 'A') ? 'checked' : ''; ?> >
                        <label for="classeA">Classe A</label>
                    </div>
                    <div class="radio-option">
                        <input type="radio" id="classeB" name="classe" value="B" <?php echo (isset($classe) && $classe == 'B') ? 'checked' : ''; ?>>
                        <label for="classeB">Classe B</label>
                    </div>
                    <div class="radio-option">
                        <input type="radio" id="classeC" name="classe" value="C" <?php echo (isset($classe) && $classe == 'C') ? 'checked' : ''; ?>>
