...
if(isset($_GET['del'])){
    supprimerUtilisateur($db,$_GET['del']);
        ...
        <div class="sidebar">
            ...
            <div class="sidebar-menu">
                <ul>
                    ...
                    <li><a href="etudiant.php"  class="active"><i class="fas fa-user-graduate"></i> Étudiants</a></li>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $utilisateur['niveau']?></td>
                            <td><?php echo $utilisateur['role']?></td>
                            <td>
                                <div class="action-buttons">
                                    <a class="action-btn btn-edit" name="modifier<?php echo $utilisateur['id']?>"><i class="fas fa-edit"></i></a>
                                    <a href="etudiant.php?del=<?php echo $utilisateur['id']?>" class="action-btn btn-delete"><i class="fas fa-trash"></i></a>
                                </div>
                            </td>
                        </tr>
                        <!-- <tr>
