...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!$errors) {
        try {
            if(connexionA($db,$_POST['email'],$_POST['password'])){
                $utilisateur=recupAdminByMail($db,$_POST['email']);
                session_start();
            ...
            */
            ...
            $alertMessage = "Une erreur est survenue lors de votre connexion ".$e;
            $alertType = "error";
...
<body>
    ...
    <div class="container">
        <div class="header">
            ...
            <p>Gerer les etudiants d un clic</p>
        </div>
        ...
        <form method="POST">
            <div class="form-group">
                ...
                <input type="email" id="email" name="email" placeholder="votre.nom@admin.edu" value="<?php echo isset($email) ? htmlspecialchars($email) : ''; ?>" >
            </div>
            ...
            <div class="footer">
                <p>pour tout probleme contacter le <a href="+237672476728">contacter ici</a></p>
            </div>
        </form>
    </div>
