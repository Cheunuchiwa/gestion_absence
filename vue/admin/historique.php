...
$justificatifs=recupJustificatifTraiter($db,$_SESSION['filiere']);
  $html= $html = '
 <!DOCTYPE html>
 <html>
 <head>
     ...
     <style>
         ...
         .user-table th {
             background-color:rgb(11, 59, 215);
             color: white;
             text-align: left;
             padding: 10px;
         }
...
// $nbreEtudiants=recupEtudiant($db);
?>
<!DOCTYPE html> 
<html lang="fr">
<head>
    ...
    <title>Dashboard Administrateur - Gestion des  etudiants</title>
        ...
        <div class="sidebar">
            ...
            <div class="sidebar-menu">
                <ul>
                    ...
                    <li><a href="historique.php" class="active"><i class="fas fa-calendar-alt" ></i> historique</a></li>
        ...
        <div class="main-content">
            ...
            <div class="table-container">
                <div class="table-header">
                    <h2>HISTORIQUE DES JUSTIFICATIFS</h2>
                ...
                <?php foreach($justificatifs as $jus){?>
                     <div class="absence-item">
    <a href="../delegue/uploads/<?php echo $jus['file']?>"><img src="../delegue/uploads/<?php echo $jus['file']?>" alt="User" class="absence-img"></a>
    <div class="absence-details">
      <div class="student-name"><?php echo $jus['nom']?></div>
      <div class="student-class"> niveau<?php echo $jus['niveau'].$jus['classe']?></div>
      <div class="absence-motif">Motif:<?php echo $jus['motif']?></div>
      <div class="absence-date">Date:<?php echo $jus['date']?></div>
      <div class="absence-comment">Commentaire : <?php echo $jus['commentaire']?></div>
      <?php if($jus['statut']=='valider'){?>
      <div class="absence-status status-valide">Validé</div><?php }else if($jus['statut']=='rejete'){ ?>
        <div class="absence-status status-rejete">Rejeté</div><?php } ?>
    </div>
  </div>
